...
$routes->get('proses', 'Mahasiswa::proses');
...
//use App\Controllers\Pages;
$routes->get('asisten', 'AsistenControllerr::index');
...
use App\Controllers\AsistenControllerr;
use App\Controllers\login;

//$routes->match(['get', 'post'], 'news/create', [News::class, 'create']);
$routes->get('login/home', [login::class, 'home']);
$routes->get('login/loginpage', [login::class, 'index']);
...
[AsistenControllerr::class, 'simpan']);

$routes->match(['get', 'post'], 'asisten/update', 
[AsistenControllerr::class, 'update']);

$routes->match(['get', 'post'], 'asisten/delete', 
[AsistenControllerr::class, 'delete']);

$routes->match(['get', 'post'], 'asisten/search', 
[AsistenControllerr::class, 'search']);
